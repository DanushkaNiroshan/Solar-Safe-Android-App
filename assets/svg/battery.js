  ...
  return (
    ...
    >
      <Path
        style='fill:#F4EFEF;'
        fill={'white'}
        d='M472,222.6c1.2,0,2,0.8,2,2v101.6h2c14.4,0,26-11.6,26-26v-96c0-14.4-12.4-26-26.8-26h-4.4
	...
	C44,361,34,347,34,332.6V172.2c0-14.4,10-23.2,24.4-23.2h356c14.4,0,24.8,10.4,24.8,24.4L438,220.2z'
      ...
      <Path
        style='fill:#54B265;'
        d='M414,153H58c-12,0-20.4,7.2-20.4,19.2v160.4c0,12,8,24.4,20.4,24.4h356.4c12,0,21.6-10.8,21.6-22.8
	 ...
	 M362,319c0,5.6-4.4,10-10,10h-16c-5.6,0-10-4.4-10-10V191c0-5.6,4.4-10,10-10h16c5.6,0,10,4.4,10,10V319z'
      ...
      <G>
        <Path
          style='fill:#F4EFEF;'
          fill={'white'}
          d='M250,191c0-3.2-2.8-6-6-6h-16c-3.2,0-6,2.8-6,6v128c0,3.2,2.8,6,6,6h16c3.2,0,6-2.8,6-6V191z'
        />
        <Path
          style='fill:#F4EFEF;'
          fill={'white'}
          d='M142,191c0-3.2-2.8-6-6-6h-16c-3.2,0-6,2.8-6,6v128c0,3.2,2.8,6,6,6h16c3.2,0,6-2.8,6-6V191z'
        />
        <Path
          style='fill:#F4EFEF;'
          fill={'white'}
          d='M358,191c0-3.2-2.8-6-6-6h-16c-3.2,0-6,2.8-6,6v128c0,3.2,2.8,6,6,6h16c3.2,0,6-2.8,6-6V191z'
        />
      </G>
      <Path
        d='M56.8,392.2C26,392.2,0,366.6,0,336.6V168.2c0-29.6,25.2-52.8,57.6-52.8h364.8c30.8,0,55.6,24.8,55.6,55.2v2
	...
	c0-26.4-21.2-47.6-47.6-47.6H57.6V123z'
      ...
      <Path
        d='M418,363H62c-15.6,0-30-14.8-30-30.4V172.2c0-16,15.2-25.2,30-25.2h356c15.6,0,27.2,11.6,27.2,26.8c0,2.4-1.6,4-4,4
	...
	c0-2.4,1.6-4,4-4s4,1.6,4,4v112C444,347.8,434.4,363,418,363z'
      />
      <Path
        d='M244,331h-16c-7.2,0-12-6.8-12-13.2v-128c0-6.4,4.8-10.8,12-10.8h16c7.2,0,12,4.4,12,10.8v128C256,324.2,251.2,331,244,331z
	 M228,187c-1.6,0-4,0.4-4,2.8v128c0,2.4,2,5.2,4,5.2h16c2,0,4-2.8,4-5.2v-128c0-2.4-2.4-2.8-4-2.8H228z'
      />
      <Path
        d='M136,331h-16c-7.2,0-12-6.8-12-13.2v-128c0-6.4,4.8-10.8,12-10.8h16c7.2,0,12,4.4,12,10.8v128C148,324.2,143.2,331,136,331z
	 M120,187c-1.6,0-4,0.4-4,2.8v128c0,2.4,2,5.2,4,5.2h16c2,0,4-2.8,4-5.2v-128c0-2.4-2.4-2.8-4-2.8H120z'
      />
      <Path
        d='M352,331h-16c-7.2,0-12-6.8-12-13.2v-128c0-6.4,4.8-10.8,12-10.8h16c7.2,0,12,4.4,12,10.8v128C364,324.2,359.2,331,352,331z
